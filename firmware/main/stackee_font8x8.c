...
const uint8_t stackee_font8x8[STACKEE_FONT_COUNT][8] = {
    ...
    {0x06, 0x09, 0x05, 0x02, 0x15, 0x09, 0x16, 0x00},  // 0x26 '&'
    ...
    {0x00, 0x00, 0x00, 0x00, 0x0C, 0x04, 0x02, 0x00},  // 0x2C ','
    ...
    {0x0E, 0x11, 0x10, 0x08, 0x04, 0x02, 0x1F, 0x00},  // 0x32 '2'
    {0x1F, 0x08, 0x04, 0x08, 0x10, 0x11, 0x0E, 0x00},  // 0x33 '3'
    ...
    {0x00, 0x0C, 0x0C, 0x00, 0x0C, 0x04, 0x02, 0x00},  // 0x3B ';'
    ...
    {0x07, 0x09, 0x11, 0x11, 0x11, 0x09, 0x07, 0x00},  // 0x44 'D'
    ...
    {0x1C, 0x08, 0x08, 0x08, 0x08, 0x09, 0x06, 0x00},  // 0x4A 'J'
    ...
    {0x11, 0x11, 0x13, 0x15, 0x19, 0x11, 0x11, 0x00},  // 0x4E 'N'
    ...
    {0x0E, 0x08, 0x08, 0x08, 0x08, 0x08, 0x0E, 0x00},  // 0x5D ']'
    ...
    {0x00, 0x00, 0x1E, 0x01, 0x01, 0x01, 0x1E, 0x00},  // 0x63 'c'
    {0x10, 0x10, 0x1E, 0x11, 0x11, 0x11, 0x1E, 0x00},  // 0x64 'd'
    {0x00, 0x00, 0x0E, 0x11, 0x1F, 0x01, 0x0E, 0x00},  // 0x65 'e'
    {0x0C, 0x12, 0x02, 0x0F, 0x02, 0x02, 0x02, 0x00},  // 0x66 'f'
    {0x00, 0x1E, 0x11, 0x11, 0x1E, 0x10, 0x0E, 0x00},  // 0x67 'g'
    {0x01, 0x01, 0x0F, 0x11, 0x11, 0x11, 0x11, 0x00},  // 0x68 'h'
    {0x04, 0x00, 0x06, 0x04, 0x04, 0x04, 0x0E, 0x00},  // 0x69 'i'
    {0x08, 0x00, 0x0C, 0x08, 0x08, 0x09, 0x06, 0x00},  // 0x6A 'j'
    {0x01, 0x01, 0x09, 0x05, 0x03, 0x05, 0x09, 0x00},  // 0x6B 'k'
    {0x06, 0x04, 0x04, 0x04, 0x04, 0x04, 0x0E, 0x00},  // 0x6C 'l'
    {0x00, 0x00, 0x0B, 0x15, 0x15, 0x11, 0x11, 0x00},  // 0x6D 'm'
    {0x00, 0x00, 0x0F, 0x11, 0x11, 0x11, 0x11, 0x00},  // 0x6E 'n'
    {0x00, 0x00, 0x0E, 0x11, 0x11, 0x11, 0x0E, 0x00},  // 0x6F 'o'
    {0x00, 0x0F, 0x11, 0x11, 0x0F, 0x01, 0x01, 0x00},  // 0x70 'p'
    {0x00, 0x1E, 0x11, 0x11, 0x1E, 0x10, 0x10, 0x00},  // 0x71 'q'
    {0x00, 0x00, 0x0D, 0x13, 0x01, 0x01, 0x01, 0x00},  // 0x72 'r'
    {0x00, 0x00, 0x1E, 0x01, 0x0E, 0x10, 0x0F, 0x00},  // 0x73 's'
    {0x02, 0x02, 0x0F, 0x02, 0x02, 0x12, 0x0C, 0x00},  // 0x74 't'
    ...
    {0x00, 0x11, 0x11, 0x11, 0x1E, 0x10, 0x0E, 0x00},  // 0x79 'y'
    {0x00, 0x00, 0x1F, 0x08, 0x04, 0x02, 0x1F, 0x00},  // 0x7A 'z'
    {0x18, 0x04, 0x04, 0x02, 0x04, 0x04, 0x18, 0x00},  // 0x7B '{'
    {0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x00},  // 0x7C '|'
    {0x03, 0x04, 0x04, 0x08, 0x04, 0x04, 0x03, 0x00},  // 0x7D '}'
    {0x00, 0x00, 0x12, 0x15, 0x09, 0x00, 0x00, 0x00},  // 0x7E '~'
};
